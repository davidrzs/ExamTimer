...
},{"process":"node_modules/process/browser.js"}],"logic.js":[function(require,module,exports) {
...
$(document).ready(function () {
  ...
  function millisecondsToHuman(duration) {
    ...
    if (duration > 0) {
      ...
      var _seconds = parseInt(duration / 1000 % 60);

      var _minutes = parseInt(duration / (1000 * 60) % 60);

      var _hours = parseInt(duration / (1000 * 60 * 60) % 24);
  ...
  function setDataAbove() {
    ...
    $('#mins_per_q').text(mins_per_q); // console.log("setData() executed");
  }

  function timeSetter(id, time) {
    var time_in_millis = time.getTime();
  ...
  function setTimeData() {
    ...
    var now = Date.now();
    var time_left_for_q = new Date(timer_start + 1000 * (current_question + 1) * mins_per_q * 60 - now); // console.log(time_left_for_q.toUTCString());

    timeSetter('#time_left_this_question', time_left_for_q);
    var total_time_left = new Date(timer_start + nr_of_mins * 60 * 1000 - now); // console.log(total_time_left.toUTCString());
  ...
  $("#entry").submit(function (event) {
    ...
    var vals = $('#entry').serializeArray().reduce(function (obj, item) {
